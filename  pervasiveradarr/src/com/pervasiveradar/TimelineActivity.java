...
import com.pervasiveradar.DevicesDiscovery;
import com.pervasiveradar.DisasterOperations;
import com.pervasiveradar.RSACrypto;
import com.pervasiveradar.KeysActions;
import com.pervasiveradar.ConnectionHelper;
import com.pervasiveradar.DirectMsgTask;
import com.pervasiveradar.FetchProfilePic;
  ...
  public boolean onOptionsItemSelected(MenuItem item){
    ...
    case LOGOUT_ID:
    	if (prefs.getBoolean("prefDisasterMode", false) == false) {
    	  ...
    	  isRunning = false;
    	  finish();
    	  startActivity(new Intent(this,MixListView.class));
    	}
    	else 
